...
urlpatterns = [
    ...
    # ==========================================
    # 2. SOFA WORKER VIEWS (Production & Masters)
    # ==========================================
    ...
    # ==========================================
    # 3. PB WORKER VIEWS (Production & Masters)
    # ==========================================
    ...
    # PB Wages
    path('reports/wage-paid-report/', views.wage_paid_report, name='wage_report_current'),
    path('reports/wage-paid-report/<int:year>/<int:month>/', views.wage_paid_report, name='wage_report'),
    ...
    path('stock-management/add-category/', views.add_stock_category, name='add_stock_category'),
    path('stock-management/edit-category/<int:cat_id>/', views.edit_stock_category, name='edit_stock_category'),
